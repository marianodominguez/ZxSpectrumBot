...
#determine language:
        ...
        result = os.system(f'ffmpeg -y -hide_banner -loglevel debug -f x11grab -pix_fmt yuv422p -r 30 -video_size 672x440 -i :99 -q:v 0 -t {recordtime} working/OUTPUT_BIG.mp4')
